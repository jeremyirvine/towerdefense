...
public class ConsoleView extends JFrame implements ActionListener
{
	...
	public ConsoleView()
	{
		...
		JList<Log> list = new JList<>(model);
		...
		case help:
			...
			} else
			{
				for (ConsoleCommands cc : ConsoleCommands.values())
				{
					...
					{
						// Announcer.printcon("\""+args+"\" is not a valid
						// command", LogLevel.WARN);
						continue;
					}
				}
			}
	...
	private class LogCellRenderer<Log> extends JLabel implements ListCellRenderer
	{
		private static final long serialVersionUID = 1L;
//		private final Color HIGHLIGHT_COLOR = new Color(0, 0, 128);
				...
				boolean cellHasFocus)
		{
			...
			data.ConsoleView.Log l = (data.ConsoleView.Log) value;
			// if (isSelected) {
